...
var RSAKeys = new sinaSSOEncoder;
var RSAKey = new RSAKeys.RSAKey;


function get_sp(password,rsaPubkey,servertime,nonce){
    RSAKey.setPublic(rsaPubkey, "10001");
    sp = RSAKey.encrypt([servertime, nonce].join("\t") + "\n" + password)
    
    return sp
}
// password='13829822835'
...
// servertime='1641797324'
// nonce='YUS6KD'
// console.log(get_sp(username,password,rsaPubkey,servertime,nonce))